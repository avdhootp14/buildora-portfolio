...
const teamMembers = [
  {
    name: "Atharv",
    image: "/atharv.png",
    github: "https://github.com/AtharvDoiphode"
  },
  {
    name: "Avdhoot",
    image: "/avdhoot.png",
    github: "https://github.com/avdhootp14"
  }
];
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <a 
                ...
                className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-[#0a0a0a] mb-8 border border-white/5 group-hover:border-[#a855f7]/40 transition-colors duration-500 block"
              >
